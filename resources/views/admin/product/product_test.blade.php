...
@php
//C:\xampp\htdocs\laravel\ec_system\public\\blog\wordpress\wp-load.php
//require_once('C:\xampp\htdocs\laravel\ec_system\public\\blog\wordpress\wp-load.php');
//require_once(dirname(__FILE__).'..\..\public\blog\wordpress\wp-load.php');
bloginfo('name');
//usces_password_policy_message();
/* $post_id= 2;
$item = wel_get_item( $post_id );
print_r($item);
*/
@endphp
