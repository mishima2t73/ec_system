...
<div class="container">
    ...
    <button type="submit" class="btn btn-secondary m-1" onclick="location.href='/admin/sales?s_date={{\Carbon\Carbon::today()->firstOfMonth()}}&e_date={{\Carbon\Carbon::today()->endOFMonth()}}'">
        今月</button>
        <button type="submit" class="btn btn-secondary m-1" onclick="location.href='/admin/sales?s_date={{\Carbon\Carbon::today()->firstOfMonth()->subMonth()}}&e_date={{\Carbon\Carbon::today()->firstOfMonth()->subMonth()->endOFMonth()}}'">
        先月</button>
        <button type="submit" class="btn btn-secondary m-1" onclick="location.href='/admin/sales?s_date={{\Carbon\Carbon::today()->firstOfMonth()->subMonth(2)}}&e_date={{\Carbon\Carbon::today()->firstOfMonth()->subMonth(2)->endOFMonth()}}'">
            先々月</button>
