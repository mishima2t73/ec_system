...
?>
		...
		printf( esc_html__( 'Copyright &copy; %1$s %2$s , All Right Reserved. %3$s by aThemeArt - Proudly powered by %4$s', 'shopstore' ), esc_attr( date( 'Y' ) ), esc_html( get_bloginfo( 'name' ) ), '<br/><a href="https://www.athemeart.com/downloads/shopstore/" title="WordPress store theme" target="_blank" rel="nofollow">Shop Store Theme</a>', '<a href="'.esc_attr( 'https://wordpress.org' ).'" target="_blank" rel="nofollow">'.esc_html_x( 'WordPress', 'credit to cms', 'shopstore' ).'</a>' );
